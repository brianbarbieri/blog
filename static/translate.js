const translations = {
    en: {
        ...
        bookText: 'Prices at Casa Modero vary between 70 and 80 euros and depend on the season and the number of nights. Please <a class="w3-text-green" href="#contact">contact us</a> for more information and to book your stay.',
    ...
    nl: {
        ...
        melanzaInfoText: "De kamer \"Melanza\" heeft een meer antiek interieur en beschikt over een privébadkamer bij de kamer. De kleuren maken het ideaal voor een romantisch uitje.",
        ...
        bookText: 'De prijzen bij Casa Modero variëren tussen 70 en 80 euro en zijn afhankelijk van het seizoen en het aantal nachten. Neem alstublieft <a class="w3-text-green" href="#contact">contact met ons op</a> voor meer informatie en om uw verblijf te boeken.',
