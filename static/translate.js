const translations = {
    en: {
        ...
        introText: "Casa Modero is a charming three-bedroom Bed & Breakfast located in Cartosio. As of May 1st, 2026, the new owners, Loris and Silvia, will be welcoming guests to this beautiful retreat. Nestled in the stunning valley of the Erro—situated between Piedmont’s finest vineyards to the north and several regional nature parks leading to the coast in the south—Casa Modero offers the perfect base for relaxation and exploration. Guests can enjoy activities such as tasting local wines and dishes, swimming in the Erro, taking a day trip to the Ligurian coast, or visiting the historic sulfur springs of Acqui Terme. Casa Modero looks forward to offering a warm welcome to everyone seeking tranquility and authentic Italian charm.",
        ...
        breakfastText: "Breakfast is included in your stay. Start your morning here with a choice of tea or coffee combined with fresh orange juice. Enjoy a delicious breakfast with local products and produce from our own garden.",
        olivoTitle: "Olivo",
        bedroom: "Bedroom",
        toilet: "Toilet",
        shower: "Shower",
        amenities: "Amenities of each room",
        amen1: "Double bed",
        amen2: "Breakfast included",
        amen3: "Bed linen and towels included",
        amen4: "Private bathroom",
        amen5: "WiFi",
        amen6: "Heating",
        amen7: "Pets allowed",
        availDates: "Open from the 1st of May till the 30th of September",
        ...
        melanzaInfoText: "The room \"Melanza\" offers a more antique interior with an adjacent private bathroom. Its colors make it ideal for a romantic getaway.",
        ...
        bookText: 'Prices at Casa Modero vary between 76 and 103 euros and depend on the season and the number of nights. Please <a class="w3-text-green" href="#contact">contact us</a> for more information and to book your stay.',
        ...
        wineriesText: "Close to Acqui Terme lies the Monferrato region that is known for its picturesque vineyards that produce wines of excellence quality. Here is is possible to learn how wine is produced, discover the perfect gastronomic combination of food and wine and take a tour of the vineyards and historical cellars.",
        hikingTitle: "Hiking",
        ...
        rules4: " - It is strictly forbidden to light fires, candles or incense inside the rooms or in the shared spaces of the house.",
        rules5: " - It is only allowed to throw toilet paper in the toilet, for other objects a bin can be found in the bathroom.",
    ...
    nl: {
        ...
        breakfastText: "Ontbijt is inbegrepen bij het verblijf. Begin uw ochtend hier met een keuze uit thee of koffie gecombineerd met vers sinaasappelsap. Geniet van het lekkere ontbijt met streekproducten en uit eigen tuin.",
        olivoTitle: "Olivo",
        bedroom: "Slaapkamer",
        toilet: "Toilet",
        shower: "Douche",
        amenities: "Voorzieningen van elke kamer",
        amen1: "Tweepersoonsbed",
        amen2: "Ontbijt inbegrepen",
        amen3: "Bedlinnen en handdoeken inbegrepen",
        amen4: "Eigen badkamer",
        amen5: "WiFi",
        amen6: "Verwarming",
        amen7: "Huisdieren toegestaan",
        availDates: "Open vanaf 1 mei t/m 30 september",
        checkIn: "Inchecken: 15:00 - 24:00",
        checkOut: "Uitchecken: vóór 10:00",
        olivoInfoText: "Olivo is de grootste en meest ruime kamer van het huis, ideaal voor hen die willen genieten van rust, comfort en privacy. De aangrenzende privébadkamer, de groentinten en de ramen met uitzicht op het bos zorgen voor een warme en ontspannen sfeer, alsof je midden in de natuur ontwaakt. Na een zonnige dag is het heerlijk thuiskomen in een koele kamer dankzij de airconditioning, die ook tijdens warme zomernachten voor een aangename temperatuur zorgt. Olivo is de perfecte plek om samen tot rust te komen en volop te genieten van een fijn verblijf.",
        melanzaInfoText: "De kamer heeft een sfeervol, antiek interieur en beschikt over een privébadkamer naast de kamer. De warme kleuren en authentieke inrichting zorgen voor een comfortabele en ontspannen sfeer.",
        cavaloInfoText: "Deze sfeervolle kamer bevindt zich in het oudste gedeelte van het huis en beschikt over een aangrenzende privébadkamer. Dankzij de rustige ligging en authentieke uitstraling is Cavalo de ideale plek om na een gezellige dag volledig tot rust te komen.",
        bookTitle: "Boek uw verblijf & Prijzen",
        bookText: 'De prijzen bij Casa Modero variëren tussen 76 en 103 euro en zijn afhankelijk van het seizoen en het aantal nachten. Neem alstublieft <a class="w3-text-green" href="#contact">contact met ons op</a> voor meer informatie en om uw verblijf te boeken.',
        ...
        wineriesText: "Dicht bij Acqui Terme ligt de regio Monferrato, bekend om haar schilderachtige wijngaarden die kwaliteitswijnen produceren. Hier is het mogelijk om te leren hoe wijn wordt geproduceerd, de perfecte gastronomische combinatie van eten en wijn te ontdekken en een tour te maken door wijngaarden en historische kelders.",
        hikingTitle: "Wandelen door de omgeving",
        ...
        coolPlacesText: "Er zijn veel plekken rond Casa Modero om af te koelen op een warme dag. Op 5 minuten afstand van het huis ligt de rivier de Erro, die de hele zomer koel blijft. Als u liever in een zwembad zwemt, bevinden we ons dicht bij het openbare zwembad van Cartosio. De Ligurische kust is ook slechts 50 minuten verwijderd, wat het de perfecte plek maakt voor een dagtocht naar het strand.",
        ...
        rules4: " - Het is strikt verboden om vuur, kaarsen of wierook aan te steken in de kamers of in de gedeelde ruimtes van het huis.",
        rules5: " - Alleen toiletpapier mag in het toilet worden gegooid, voor andere objecten is er een prullenbak in de badkamer.",
        rules6: " - Tussen 23:30 en 08:00 graag geen geluidsoverlastt. Gedurende de rest van de dag wordt van iedereen verwacht een respectvolle en passende houding aan te nemen uit respect voor alle gasten.",
...
function updateLanguage() {
    ...
    // Main content
    document.getElementById('welcomeText').innerText = translations[currentLang].welcomeText;
    document.getElementById('introText').innerText = translations[currentLang].introText;

    document.getElementById('facilitiesTitle').innerText = translations[currentLang].facilitiesTitle;
    document.getElementById('facilitiesText').innerText = translations[currentLang].facilitiesText;

    document.getElementById('breakfastTitle').innerText = translations[currentLang].breakfastTitle;
    document.getElementById('breakfastText').innerText = translations[currentLang].breakfastText;

    document.querySelectorAll('.availDates').forEach(el => el.innerText = translations[currentLang].availDates);
    ...
    document.getElementById('wineriesTitle').innerText = translations[currentLang].wineriesTitle;
    document.getElementById('wineriesText').innerText = translations[currentLang].wineriesText;
    document.getElementById('hikingTitle').innerText = translations[currentLang].hikingTitle;
    ...
    document.querySelectorAll('.toilet').forEach(el => el.innerText = translations[currentLang].toilet);
    document.querySelectorAll('.shower').forEach(el => el.innerText = translations[currentLang].shower);
    document.querySelectorAll('.amenities').forEach(el => el.innerText = translations[currentLang].amenities);
    for (let i = 1; i <= 7; i++) {
        document.querySelectorAll(`.amen${i}`).forEach(el => el.innerText = translations[currentLang][`amen${i}`]);
    }
    for (let i = 1; i <= 9; i++) {
